...
function Profile() {
    ...
    const classNameSelectProfile = selectProfile ? "border-b-[10px] border-black ml-2 py-2 px-3 border-b-[12px] z-10" : "border-b-[12px] border-white ml-2 py-2 px-3"
    const classNameSelectSetting = selectSetting ? "border-b-[10px] border-black ml-4 py-2 px-3 border-b-[12px] z-10" : "border-b-[12px] border-white ml-4 py-2 px-3"
            ...
            <div className="h-full w-[60%] px-20 pt-8 mt-8">
                <div className="flex justify-between">
                    <div>
                        ...
                        <p className="text-base py-2">ทุกคนจะเห็นช์่อนี้บน โปรไฟล์ของคุณและสามารถเปลี่ยนได้ทุกเมื่อ</p>
                    ...
                    <div className="flex flex-col avatar relative">
                        ...
                        <button className="bg-gray-100 font-semibold w-20 absolute bottom-[-15px] left-24">แก้ไข</button>
                    </div>
                </div>
            </div>
        </div>
