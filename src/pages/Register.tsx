...
function Register() {
  ...
  function handleClickStudent() {
    ...
    {
      navigate(
        { pathname: "/register", search: `?${queryparam.toString()}` },
        { replace: true },
      );
    }
  }
    ...
    return (
      <div className=" flex flex-col h-screen relative">
        <button
          ...
          className=" text-2xl font-semibold ml-[1%] mt-[1%] text-left relative"
        >
          ย้อนกลับ
        </button>
        ...
        <div className=" flex flex-row w-full h-full overflow-hidden">
          <div className="w-full h-screen relative">
            ...
            <button
              className=" absolute z-40 bottom-[20%] left-[35%] text-white bg-[#007399] p-2 rounded-md shadow-md text-[24px]"
            ...
            <img
              src={studentImage}
              alt="stdImg"
              className=" z-0 w-full h-full opacity-20 relative"
          ...
          <div className="w-full h-full relative">
            ...
            <div className=" absolute z-40 top-[15%] left-[20%] flex flex-col text-xl font-bold">
              <p>
                ผู้ใช้ที่เข้าแพลทฟอร์มมาเพื่อเปิดห้องเรียนสร้างและเผยแพร่สื่อการสอน
              </p>
        ...
        <div className=" flex flex-row space-x-[1%] h-[10%] items-center justify-center">
          ...
          <button
            className=" font-bold text-[#007399] text-lg"
            onClick={handleClickRegister}
          >
            คลิกเพื่อลงชื่อเข้าสู่ระบบ
          </button>
        </div>
      </div>
    );
  else if (searchParams.get("u") === "student") return <StudentsRegister />;
  else if (searchParams.get("u") === "teacher") return <TeacherRegister />;
}
