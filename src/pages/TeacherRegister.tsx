        ...
        <div className=" bg-gray-300 h-screen">
            <div className=" grid grid-cols-2">
                <div className=" h-screen">
                    <img src={smolRobotImage} alt="smolRobotImage" className=" z-0 w-full h-full relative object-cover" overflow-hidden={true}></img>
                    <button onClick={() => { navigate('/register', { replace: true }) }} className="absolute top-6 text-[24px] text-slate-700 ml-[2%]">Back</button>
                </div>
