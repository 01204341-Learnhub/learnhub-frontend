import AnnouncementDropdown from  "../../features/learns/components/AnnouncementDropdown"
    ...
    return (
        <>
            <div>
                {courses.map(course => (
                    <div>
                        <AnnouncementDropdown title={course.title} works={course.works} Studied={course.Studied} TotalTime={course.TotalTime}/>
                    </div>
                ))}
            </div>
        </>
