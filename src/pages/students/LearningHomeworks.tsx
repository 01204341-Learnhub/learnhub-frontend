  ...
  return (
    <div className=" flex flex-row w-full h-full shadow-xl relative mt-[1%]">
      ...
      <div className=" flex flex-row-reverse absolute w-full whitespace-nowrap mt-[5%]">
        <div className=" absolute text-lg mr-[3%]">
          ถึงวัน{props.deadlineDayOfWeek} {props.deadlineTime} น.
        </div>
      </div>
    </div>
  );
...
function LearningHomeworks() {
  ...
  const mockList = [
    {
      ...
      homeworkName: "What is Redstone",
      deadlineDayOfWeek: "ศุกร์",
      deadlineTime: "12:00",
    },
    {
      titleName: "Principal Greenstone Designs",
      homeworkName: "What is Greenstone",
      deadlineDayOfWeek: "เสาร์",
      deadlineTime: "9:00",
    },
  ];
  ...
  function handleClickDropdownAllClass() {
    const toggleDivDropdownAllClass =
      document.getElementById("dropDownAllClass");
  ...
  function handleClickDropdownAssignNoDueDate() {
    const toggleDivDropdownAssignNoDueDate = document.getElementById(
      "dropDownAssignNoDueDate",
    );
    const toggleIconAssignNoDueDate = document.getElementById(
      "iconAssignNoDueDate",
    );
  ...
  function handleClickDropdownAssignThisWeek() {
    const toggleDivDropdownAssignThisWeek = document.getElementById(
      "dropDownAssignThisWeek",
    );
    const toggleIconAssignThisWeek =
      document.getElementById("iconAssignThisWeek");
  ...
  function handleClickDropdownAssignNextWeek() {
    const toggleDivDropdownAssignNextWeek = document.getElementById(
      "dropDownAssignNextWeek",
    );
    const toggleIconAssignNextWeek =
      document.getElementById("iconAssignNextWeek");
  ...
  function handleClickDropdownAssignAfter() {
    const toggleDivDropdownAssignAfter = document.getElementById(
      "dropDownAssignAfter",
    );
  ...
  function handleClickDropdownLateThisWeek() {
    const toggleDivDropdownLateThisWeek = document.getElementById(
      "dropDownLateThisWeek",
    );
  ...
  function handleClickDropdownLatePrevWeek() {
    const toggleDivDropdownLatePrevWeek = document.getElementById(
      "dropDownLatePrevWeek",
    );
  ...
  function handleClickDropdownLateBefore() {
    const toggleDivDropdownLateBefore =
      document.getElementById("dropDownLateBefore");
  ...
  function handleClickDropdownFinishThisWeek() {
    const toggleDivDropdownFinishThisWeek = document.getElementById(
      "dropDownFinishThisWeek",
    );
    const toggleIconFinishThisWeek =
      document.getElementById("iconFinishThisWeek");
  ...
  function handleClickDropdownFinishPrevWeek() {
    const toggleDivDropdownFinishPrevWeek = document.getElementById(
      "dropDownFinishPrevWeek",
    );
    const toggleIconFinishPrevWeek =
      document.getElementById("iconFinishPrevWeek");
  ...
  function handleClickDropdownFinishBefore() {
    const toggleDivDropdownFinishBefore = document.getElementById(
      "dropDownFinishBefore",
    );
    ...
    <div>
      <div className=" flex space-x-[5%] font-extrabold text-2xl ml-[3%]">
        <button
          ...
          className={
            click_assign
              ? "underline underline-offset-[6px] decoration-[#18334E] decoration-8"
              : ""
          }
      ...
      <div className=" ml-[20%]">
        <div className=" box-border h-[50px] w-[450px] border border-black mt-10 relative flex items-center">
          <button
            onClick={handleClickDropdownAllClass}
            className=" absolute right-4 gr"
          >
            <FontAwesomeIcon
              id="iconAllClass"
              icon={faCaretDown}
        ...
        <button id="dropDownAllClass" className=" hidden absolute z-40">
          {mockList.map((item) => (
            <div className=" relative box-border h-[70px] w-[450px] border border-black bg-white flex flex-cols group hover:shadow-xl">
              <div className=" absolute h-full w-[2%] group-hover:bg-black"></div>
        ...
        <div id="toggleDivAssign" className=" z-0">
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-10 relative flex items-center">
            <button
              onClick={handleClickDropdownAssignNoDueDate}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconAssignNoDueDate"
                icon={faCaretDown}
                size="2xl"
              ></FontAwesomeIcon>
            </button>
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownAssignThisWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconAssignThisWeek"
                icon={faCaretDown}
                size="2xl"
              ></FontAwesomeIcon>
            </button>
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownAssignNextWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconAssignNextWeek"
                icon={faCaretDown}
                size="2xl"
              ></FontAwesomeIcon>
            </button>
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownAssignAfter}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconAssignAfter"
        ...
        <div id="toggleDivLate" className=" hidden z-0">
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-10 relative flex items-center">
            <button
              onClick={handleClickDropdownLateThisWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconLateThisWeek"
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownLatePrevWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconLatePrevWeek"
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownLateBefore}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconLateBefore"
        ...
        <div id="toggleDivFinish" className=" hidden z-0">
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-10 relative flex items-center">
            <button
              onClick={handleClickDropdownFinishThisWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconFinishThisWeek"
                icon={faCaretDown}
                size="2xl"
              ></FontAwesomeIcon>
            </button>
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownFinishPrevWeek}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconFinishPrevWeek"
                icon={faCaretDown}
                size="2xl"
              ></FontAwesomeIcon>
            </button>
          ...
          <div className=" box-border h-[70px] w-[800px] border border-black bg-[#D9D9D9] mt-4 relative flex items-center">
            <button
              onClick={handleClickDropdownFinishBefore}
              className=" absolute right-4"
            >
              <FontAwesomeIcon
                id="iconFinishBefore"
