    ...
    return (
        <div className="bg-white flex flex-col">
            ...
            <div className="flex items-center">
                ...
                <button onClick={() => { onChangeMode("main") }} className="mx-auto">
...
function CreateCourse() {
    ...
    if (currentView === "main") return (
        <div className="bg-[#f5f5f5]">
            <_TopPanel basicCouseInfo={basicCouseInfo} courseThumbnailUrl={fakeThumbnail} />
    ...
    else if (currentView == "purpose") return (
        <div className="bg-[#f5f5f5]">
            <_TopPanel basicCouseInfo={basicCouseInfo} courseThumbnailUrl={fakeThumbnail} />
            <div className="flex">
                <div className="w-3/12">
                ...
                <div className="bg-white font-bold w-full">
                    ...
                    <hr />
                    <p>คำอธิบายต่อไปนี้จะปรากฏต่อสาธารณะในหน้าเริ่มต้นของหลักสูตร และจะมีผลโดยตรงต่อประสิทธิภาพหลักสูตรของคุณ คำอธิบายเหล่านี้จะช่วยให้ผู้เรียนตัดสินใจว่าหลักสูตรของคุณเหมาะกับพวกเขาหรือไม่</p>
                    <h2>ผู้เรียนจะได้เรียนสิ่งใดในหลักสูตรของคุณ</h2>
                    <p>คุณต้องกรอกจุดประสงค์การเรียนรู้หรือผลลัพธ์ที่ผู้เรียนคาดหวังหลังจากเรียนจบหลักสูตรอย่างน้อย 4 รายการ</p>
                    ...
                    <input type="text" className="input input-bordered w-full rounded-none m-2" placeholder="ตัวอย่าง: มีความชำนาญในการสร้างอุปกรณ์จาก Redstone" />
                    <input type="text" className="input input-bordered w-full rounded-none m-2" placeholder="ตัวอย่าง: มีความชำนาญในการเล่น Minecraft" />
                    <h2>ความต้องการหรือข้อกำหนดเบื้องต้นสำหรับการเรียนหลักสูตรของคุณมีอะไรบ้าง</h2>
                    <p>ระบุทักษะที่จำเป็น ประสบการณ์ เครื่องมือหรืออุปกรณ์ที่ผู้เรียนควรมีก่อนเรียนหลักสูตรหากไม่มีความต้องการ ให้ใช้พื้นที่นี้เป็นโอกาสในการลดอุปสรรคสำหรับผู้เริ่มต้น</p>
                    ...
                    <div className="flex">
                        ...
                        <input type="text" className="input input-bordered rounded-none m-2" />
                    </div>
                </div>
            </div>
        </div>
    )
    else if (currentView == "publish") return (
        <div className="bg-[#f5f5f5]">
            <_TopPanel basicCouseInfo={basicCouseInfo} courseThumbnailUrl={fakeThumbnail} />
            <div className="flex">
                <div className="w-3/12">
                ...
                <div className="bg-white font-bold w-full">
                    ...
                    <input type="text" className="input input-bordered w-full rounded-none m-2" value={basicCouseInfo.courseName} />
                    ...
                    <input type="text" className="input input-bordered w-full rounded-none m-2" placeholder="เพิ่มคำอธิบาย course เรียน" />
                    ...
                    <input type="text" className="input input-bordered w-2/12 rounded-none m-2" value={basicCouseInfo.courseCategory} />
                </div>
            </div>
        </div>
    )
