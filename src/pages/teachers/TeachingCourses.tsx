...
function TeachingCourses() {
    ...
    useEffect(() => {
        ...
        setIsFetching(true)
        fetchCourses().then(() => { setIsFetching(false) })
    }, [])
    ...
    return (
        <div className="ml-10">
            <div className="flex m-6">
                ...
                <h2 className="rounded-t-lg rounded-b-lg bg-pink-500 justify-center items-center flex m-3">course</h2>
                <div className="flex drop-shadow-md ml-5">
                    <input type="text" className="input input-bordered w-full rounded-none" placeholder="ค้นหาคอร์สเรียนของฉัน" />
